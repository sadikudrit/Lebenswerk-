...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  hero: {
    ...
    headlineMain: "Ihre Gesundheit in besten Händen.",
    headlineHighlight: "Individuell. Persönlich. Vor Ort.",
    paragraph1: "Willkommen in der Praxis für Physiotherapie LEBENSWERK in Biberist. Wir begleiten Sie mit fachlicher Kompetenz, moderner Evidenz und persönlicher Zuwendung auf Ihrem Weg zu Schmerzfreiheit, mehr Beweglichkeit und Lebensqualität.",
    paragraph2: "Ob in unseren modernen Praxisräumen an der Hauptstrasse 19 oder bequem im Rahmen eines ärztlich verordneten Domizilbesuchs bei Ihnen zu Hause: Wir nehmen uns Zeit für Ihre individuellen Anliegen und erstellen einen massgeschneiderten Therapieplan.",
    ...
    scheduleSaturday: "Samstag: 08:00 – 14:00 Uhr (flexible Termine)",
  },
  doctor: {
    ...
    bioParagraph1: "Vigan Musliu bietet individuelle, persönliche und zuverlässige physiotherapeutische Betreuung an der Hauptstrasse 19 in 4562 Biberist sowie bei Hausbesuchen. Mit fundierter klinischer Erfahrung verbindet er evidenzbasierte manuelle Therapie, Schmerztherapie und aktive Rehabilitation.",
    bioParagraph2: "Besonders am Herzen liegt mir die persönliche Betreuung – ob bei uns in der Praxis in Biberist oder im Rahmen von Domizilbehandlungen bei Ihnen zu Hause in der gesamten Region Solothurn.",
  ...
  footer: {
    ...
    bannerText: "Behandlungen an der Hauptstrasse 19 in 4562 Biberist oder bequeme Hausbesuche bei Ihnen zu Hause. Individuell und zuverlässig.",
    bookingButtonText: "Termin Jetzt Buchen",
    phoneButtonPrefix: "anrufen",
    brandDescription: "Individuelle, persönliche und zuverlässige physiotherapeutische Betreuung an der Hauptstrasse 19 in 4562 Biberist sowie Domizilbehandlungen in der gesamten Region Solothurn & Biberist.",
