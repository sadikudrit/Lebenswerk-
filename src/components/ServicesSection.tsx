...
export const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  return (
    <section id="services" className="py-16 sm:py-24 bg-[#E8F5E9]/60 border-t border-[#A5D6A7] relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 -left-32 w-80 h-80 bg-[#66BB6A]/20 rounded-full blur-3xl pointer-events-none -z-10" 
      />
